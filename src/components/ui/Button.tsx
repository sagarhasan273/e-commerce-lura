...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    outline: 'border border-primary-300 text-primary-800 hover:border-primary-400 hover:bg-primary-50',
    ghost: 'text-primary-800 hover:bg-primary-100 active:bg-primary-200',
  };
